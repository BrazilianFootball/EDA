...
if __name__ == '__main__':
    ...
    IndependentsPoissonModel('Serie_A', year, n_sims).run_model()
    if cleaning: os.system('clear')
    print('Independents Poisson - Serie B')
    IndependentsPoissonModel('Serie_B', year, n_sims).run_model()

    if cleaning: os.system('clear')
    print('Holgates Bivariate Poisson - Serie A')
    HolgatesPoissonModel('Serie_A', year, n_sims).run_model()
    if cleaning: os.system('clear')
    print('Holgates Bivariate Poisson - Serie B')
    HolgatesPoissonModel('Serie_B', year, n_sims).run_model()

    if cleaning: os.system('clear')
    print('Shock Models - Serie A')
    ShockModel('Serie_A', year, n_sims).run_model()
    if cleaning: os.system('clear')
    print('Shock Models - Serie B')
    ShockModel('Serie_B', year, n_sims).run_model()